...
class JmsRecentlyBought extends Module
{
    public function __construct()
    {
        ...
        $this->description = $this->l('show sale notification on frontend, it help site get more sale.');
    }
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submitSetting')) {
            Configuration::updateValue('JRB_ENABLE', Tools::getValue('JRB_ENABLE'));
            Configuration::updateValue('JRB_POPUP_SHOW_ANIMATE', Tools::getValue('JRB_POPUP_SHOW_ANIMATE'));
            Configuration::updateValue('JRB_POPUP_HIDE_ANIMATE', Tools::getValue('JRB_POPUP_HIDE_ANIMATE'));
            Configuration::updateValue('JRB_POPUP_POSITION', Tools::getValue('JRB_POPUP_POSITION'));
            Configuration::updateValue('JRB_IMAGE_POSITION', Tools::getValue('JRB_IMAGE_POSITION'));
            Configuration::updateValue('JRB_EXTERNAL_LINK', Tools::getValue('JRB_EXTERNAL_LINK'));
            Configuration::updateValue('JRB_CLOSE_ICON', Tools::getValue('JRB_CLOSE_ICON'));
            Configuration::updateValue('JRB_USE_CACHE', Tools::getValue('JRB_USE_CACHE'));
            Configuration::updateValue('JRB_AJAX', Tools::getValue('JRB_AJAX'));
            Configuration::updateValue('JRB_GET_PRODUCT_TYPE', Tools::getValue('JRB_GET_PRODUCT_TYPE'));
            Configuration::updateValue('JRB_ORDER_TIME', Tools::getValue('JRB_ORDER_TIME'));
            Configuration::updateValue('JRB_ORDER_TIME_UNIT', Tools::getValue('JRB_ORDER_TIME_UNIT'));
            Configuration::updateValue('JRB_ORDER_STATUS', json_encode(Tools::getValue('JRB_ORDER_STATUS')));
            Configuration::updateValue('JRB_FRAME_TIME', Tools::getValue('JRB_FRAME_TIME'));
            Configuration::updateValue('JRB_POPUP_CONTENT', Tools::getValue('JRB_POPUP_CONTENT'));
            Configuration::updateValue('JRB_ADDRESS_LIST', Tools::getValue('JRB_ADDRESS_LIST'));
            Configuration::updateValue('JRB_LOOP', Tools::getValue('JRB_LOOP'));
            Configuration::updateValue('JRB_INIT_TIME', Tools::getValue('JRB_INIT_TIME'));
            Configuration::updateValue('JRB_DISPLAY_TIME', Tools::getValue('JRB_DISPLAY_TIME'));
            Configuration::updateValue('JRB_NEXT_TIME', Tools::getValue('JRB_NEXT_TIME'));
            Configuration::updateValue('JRB_TOTAL', Tools::getValue('JRB_TOTAL'));
            Configuration::updateValue('JRB_BACKGROUND', Tools::getValue('JRB_BACKGROUND'));
            Configuration::updateValue('JRB_BORDER_RADIUS', Tools::getValue('JRB_BORDER_RADIUS'));
            Configuration::updateValue('JRB_TEXT_COLOR', Tools::getValue('JRB_TEXT_COLOR'));
            Configuration::updateValue('JRB_LINK_COLOR', Tools::getValue('JRB_LINK_COLOR'));
            Configuration::updateValue('JRB_TIME_COLOR', Tools::getValue('JRB_TIME_COLOR'));
            Configuration::updateValue('JRB_TEXT_SIZE', Tools::getValue('JRB_TEXT_SIZE'));
            Configuration::updateValue('JRB_LINK_SIZE', Tools::getValue('JRB_LINK_SIZE'));
            Configuration::updateValue('JRB_TIME_SIZE', Tools::getValue('JRB_TIME_SIZE'));
            Configuration::updateValue('JRB_CUSTOM_CSS', Tools::getValue('JRB_CUSTOM_CSS'));
            if (!Tools::isSubmit('JRB_ORDER_STATUS')) {
                Configuration::updateValue('JRB_ORDER_STATUS', '[]');
            } else {
                Configuration::updateValue('JRB_ORDER_STATUS', json_encode(Tools::getValue('JRB_ORDER_STATUS')));
            }
            if (!Tools::isSubmit('JRB_SELECT_CATEGORY')) {
                Configuration::updateValue('JRB_SELECT_CATEGORY', '[]');
            } else {
                Configuration::updateValue('JRB_SELECT_CATEGORY', json_encode(Tools::getValue('JRB_SELECT_CATEGORY')));
            }
            if (!Tools::isSubmit('JRB_SELECT_PRODUCT')) {
                Configuration::updateValue('JRB_SELECT_PRODUCT', '[]');
            } else {
                Configuration::updateValue('JRB_SELECT_PRODUCT', json_encode(Tools::getValue('JRB_SELECT_PRODUCT')));
            }
        ...
        $helper->fields_value = array(
            ...
            'JRB_ORDER_STATUS[]' => Tools::getValue(
                'JRB_ORDER_STATUS',
                json_decode(Configuration::get('JRB_ORDER_STATUS'))
            ),
            ...
            'JRB_SELECT_CATEGORY' => implode(', ', Tools::getValue(
                'JRB_SELECT_CATEGORY',
                json_decode(Configuration::get('JRB_SELECT_CATEGORY'))
            )),
            'JRB_SELECT_PRODUCT' => implode(', ', Tools::getValue(
                'JRB_SELECT_PRODUCT',
                json_decode(Configuration::get('JRB_SELECT_PRODUCT'))
            )),
    ...
    public function hookDisplayBeforeBodyClosingTag($params)
    {
        ...
        $this->context->smarty->assign(
            array(
                ...
                'ajaxpath' => __PS_BASE_URI__.'modules/'.$this->name.'/ajax_'.$this->name.'.php',
            )
        );
