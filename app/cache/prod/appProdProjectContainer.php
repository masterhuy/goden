...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'jms_goden', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_c618f717056743e599aee1e7e8553382a2467d32e0e8e1f36803b42590cc6821');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('aX9NSiXSMp71LvwEBQhU2hMc3y7pAfJVmgkrb4E2E4rWPHLWYfr5t67V');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5aec337052a227.50255754')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.active_modules' => array(
                ...
                64 => 'jmsblog',
                65 => 'jmsblogwidget',
                66 => 'jmscustomhtmlleft',
                67 => 'jmsfacebookconnect',
                68 => 'jmspagebuilder',
                69 => 'jmswishlist',
            ...
            'secret' => 'aX9NSiXSMp71LvwEBQhU2hMc3y7pAfJVmgkrb4E2E4rWPHLWYfr5t67V',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-04-17',
            'locale' => 'en-US',
            'cookie_key' => 'YIdeu766e97ZbmDbbBZFDdhVcxfM4sEQ9hUcjirpXsAu5QNVBFmhC7mG',
            'cookie_iv' => 'p94DrR2m',
            'new_cookie_key' => 'def0000036408ff0e58a345d1af12e1237962b6b09ada1fd6cb41034855d2c946d304e2c5b5e6d56c21f8a90fb1c548eca290709ea98de756913a7477d4f0a0bd595493c',
            ...
            'kernel.secret' => 'aX9NSiXSMp71LvwEBQhU2hMc3y7pAfJVmgkrb4E2E4rWPHLWYfr5t67V',
